...
import BrandsDrawer from "@/components/drawer/BrandsDrawer";
...
const Brands = () => {
    ...
    return (
        <>
            <PageTitle>{t("BrandspageTitle")}</PageTitle>
            <DeleteModal
                ids={allId}
                    ...
                    <Table>
                        <TableHeader>
                            <tr>
                                ...
                                <TableCell>{t("Brand Image")}</TableCell>

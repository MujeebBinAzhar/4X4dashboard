...
import StockManagementSetting from "@/components/settings/StockManagementSetting";
...
const StoreHome = () => {
  ...
  useEffect(() => {
    if (tabName === "stock-management-setting") {
      setTabIndex(10);
    } else if (tabName === "seo-setting") {
      setTabIndex(9);
  ...
  return (
    <>
      ...
      <>
        ...
        {/************* TabPanel 10 - Stock Management Setting *************/}
        {tabName === "stock-management-setting" && (
          <StockManagementSetting />
        )}
        {/************* TabPanel 10 END*************/}
      </>
    </>
